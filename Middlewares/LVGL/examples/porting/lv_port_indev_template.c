...
// data); static bool touchpad_is_pressed(void); static void
...
void lv_port_indev_init(void) {
    ...
    //    indev_drv.read_cb = keypad_read;//键盘键值读取函数
    //    indev_keypad = lv_indev_drv_register(&indev_drv);
    // 注意下面的注释，我们需要使用lv_group_create
    ...
    static const lv_point_t btn_points[4] = {
        {80, 155},  /*Button 0 -> x:10; y:10*/
        {271, 155}, /*Button 1 -> x:40; y:100*/
        {80, 228},
        {271, 228},
    };
...
//    uint32_t act_key =
//    keypad_get_key();//读取下面按下按键后转换的键值,这里没有使用函数，直接使用全局量传进来进行键值转换
//    if(act_key != 0&& act_key != 0xff) {
//        data->state = LV_INDEV_STATE_PR;
//				 /* 将键值转换成 LVGL 的控制字符 */
//        /*Translate the keys to LVGL control characters according to your key
//        definitions*/ switch(act_key) { case 1:
//            act_key = LV_KEY_NEXT;
//            break;
//        case 2:
//            act_key = LV_KEY_PREV;
...
// static uint32_t keypad_get_key(void)
//{
//     if (TK_TouchKeyStatus & 0x80) { //重要步骤2:
