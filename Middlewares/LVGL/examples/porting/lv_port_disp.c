...
void lv_port_disp_init(void) {
    ...
    static uint8_t
        buf_1_1[MY_DISP_HOR_RES * MY_DISP_LINE_COUNT * BYTE_PER_PIXEL]; /*A buffer for 10 rows*/
...
static void disp_flush(lv_display_t *disp_drv, const lv_area_t *area, uint8_t *px_map) {
    Lcd_Refrsh_DMA(QSPI1, area->x1, area->x2, area->y1, area->y2, (uint16_t *)px_map);
