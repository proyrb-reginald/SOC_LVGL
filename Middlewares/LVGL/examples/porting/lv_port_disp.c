...
//    actual screen width, default value 480 is used for now.
#define MY_DISP_HOR_RES 480
#endif

#ifndef MY_DISP_VER_RES
//    #warning Please define or replace the macro MY_DISP_HOR_RES with the
//    actual screen height, default value 272 is used for now.
#define MY_DISP_VER_RES 272
#endif
/*	MY_DISP_HOR_RES为水平像素的大小 MY_DISP_VER_RES为垂直方向的像素大小
 */
/**********************
 *      TYPEDEFS
 **********************/
...
void lv_port_disp_init(void) {
     ...
     */
    /**
     *此处的说明为LVGL的三种缓冲区配置，这里我们选择第一种缓冲方式
     *
     **/
    /* Example for 1) */
    ...
    //    static lv_color_t buf_2_1[MY_DISP_HOR_RES * 10]; /*A buffer for 10
    //    rows*/ static lv_color_t buf_2_2[MY_DISP_HOR_RES * 10]; /*An other
    //    buffer for 10 rows*/ lv_disp_draw_buf_init(&draw_buf_dsc_2, buf_2_1,
    ...
    //    screen sized buffer*/ static lv_color_t buf_3_2[MY_DISP_HOR_RES *
    ...
    disp_drv.ver_res = MY_DISP_VER_RES; // 修改屏幕对应的大小
...
static void disp_flush(lv_disp_drv_t *disp_drv, const lv_area_t *area,
    ...
    //		DispColor(QSPI1, area->x1, area->x2, area->y1, area->y2,
    //(uint16_t *)color_p);
    Lcd_Refrsh_DMA(QSPI1, area->x1, area->x2, area->y1, area->y2,
                   (uint16_t *)color_p);
